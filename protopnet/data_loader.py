...
def dataloader(df_train, df_val, df_test, g):
    ...
    #transform_train, transform_val, transform_push = data_transforms(img_size)
    ...
    #dataloader_test = DataLoader(dataset_gen_test, batch_size=batch_size, shuffle=False, num_workers=num_workers, collate_fn=MyCollate, worker_init_fn=seed_worker, generator=g)
