...
print(ppnet.module.last_layer.weight.shape, flush=True)
...
tables = []
print("logits size:", logits.size(0))
...
##### MOST ACTIVATED (NEAREST) 10 PROTOTYPES OF THIS IMAGE based on only activation value (similarity)
