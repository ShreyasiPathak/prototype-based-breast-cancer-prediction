...
class ModelCheckpoint:
    ...
    def __init__(self, path_to_model, criteria, best_score = None, patience=7, verbose=False):
        """
        Args:
    ...
    def __call__(self, val_loss, model, conf_mat_train1, conf_mat_test1, warm_optimizer, joint_optimizer, epoch_warm, epoch_joint, val_auc):
        ...
        if self.best_score is None:
            ...
            self.save_checkpoint(val_loss, model, conf_mat_train1, conf_mat_test1, warm_optimizer, joint_optimizer, epoch_warm, epoch_joint, val_auc)
        elif score > self.best_score:
            self.best_score = score
            self.save_checkpoint(val_loss, model, conf_mat_train1, conf_mat_test1, warm_optimizer, joint_optimizer, epoch_warm, epoch_joint, val_auc)

    def save_checkpoint(self, val_loss, model, conf_mat_train1, conf_mat_test1, warm_optimizer, joint_optimizer, epoch_warm, epoch_joint, val_auc):
        ...
        state = {
            ...
            'optimizer_warm': warm_optimizer.state_dict(),
...
def save_model(model, warm_optimizer, joint_optimizer, epoch_warm, epoch_joint, val_auc, path_to_model):
    state = {
        'epoch_warm': epoch_warm,
        'epoch_joint': epoch_joint,
        'model_state_dict': model.state_dict(),
