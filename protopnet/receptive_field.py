...
def compute_layer_rf_info(layer_filter_size, layer_stride, layer_padding,
    ...
    #print("layer filter size:", layer_filter_size)
    #print("layer stride:", layer_stride)
    #print("layer padding:", layer_padding)
...
def compute_rf_protoL_at_spatial_location(img_size, height_index, width_index, protoL_rf_info):
    ...
    #print("protoL_rf_info:", protoL_rf_info)
    #print("height index, width index:", height_index, width_index)
